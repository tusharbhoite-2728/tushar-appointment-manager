...
/**
 * Servlet implementation class ChangePasswordEmployee
 */
public class ChangePasswordEmployee extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{   
			...
			if(rs.next())
			{
				PreparedStatement ps1 = con.prepareStatement("update employee set epassword=? where eemail=?");
			...
			{
		    	response.sendRedirect("ChangePasswordEmployeeForm.html");
